...
export default function FundingProgress({
  ...
  return (
    <div className="rounded-xl border border-[var(--border)] bg-[var(--bg-input)] p-5 space-y-3">
      ...
      <div className="flex items-center justify-between text-sm">
        <span className="text-[var(--text-secondary)]">
          <span className="font-semibold text-[var(--text-primary)]">{formatCurrency(totalCommitted)}</span>
          {" / "}
