    ...
    <div className="px-6 py-10">
      <div className="mx-auto max-w-2xl">
        ...
        <section className="bg-[var(--bg-card)] border border-[var(--border)] rounded-2xl p-6 space-y-4">
          ...
          <div>
            <label className="text-sm text-[var(--text-secondary)]">Accreditation Type *</label>
            <select
          ...
          <div>
            <label className="text-sm text-[var(--text-secondary)]">Proof / Supporting Details (optional)</label>
            <textarea
