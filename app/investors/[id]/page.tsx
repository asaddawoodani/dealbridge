      ...
      <div className="mx-auto max-w-3xl space-y-6">
        ...
        <div className="bg-[var(--bg-card)] border border-[var(--border)] rounded-2xl p-6">
          <div className="flex items-start justify-between gap-4">
            ...
            {level === "self" && (
              <Link
                href="/profile"
                className="rounded-lg bg-[var(--bg-elevated)] border border-[var(--border)] px-4 py-2 text-sm font-medium text-[var(--text-secondary)] hover:text-[var(--text-primary)] hover:border-[var(--border-hover)] transition-all shrink-0"
              >
                Edit Profile
              </Link>
            )}
        ...
        <div className={`grid gap-4 ${level === "limited" ? "grid-cols-2 sm:grid-cols-4" : "grid-cols-2 sm:grid-cols-4"}`}>
          <div className="bg-[var(--bg-card)] border border-[var(--border)] rounded-xl p-4">
            <div className="text-xs text-[var(--text-muted)] mb-1">Check Size</div>
          ...
          {level === "limited" ? (
            <>
              <div className="bg-[var(--bg-card)] border border-[var(--border)] rounded-xl p-4">
                <div className="text-xs text-[var(--text-muted)] mb-1">Involvement</div>
                <div className="text-lg font-semibold">{formatInvolvement(investorProfile.involvement)}</div>
              </div>
              <div className="bg-[var(--bg-card)] border border-[var(--border)] rounded-xl p-4">
                <div className="text-xs text-[var(--text-muted)] mb-1">Sectors</div>
            ...
            <>
              <div className="bg-[var(--bg-card)] border border-[var(--border)] rounded-xl p-4">
                <div className="text-xs text-[var(--text-muted)] mb-1">Deals Committed</div>
                <div className="text-lg font-semibold">{dealsCommitted}</div>
              </div>
              <div className="bg-[var(--bg-card)] border border-[var(--border)] rounded-xl p-4">
                <div className="text-xs text-[var(--text-muted)] mb-1">Total Invested</div>
        ...
        <div className="bg-[var(--bg-card)] border border-[var(--border)] rounded-2xl p-6">
          ...
          {categories.length > 0 && (
            <div className="mb-4">
              <div className="text-sm text-[var(--text-muted)] mb-2">Preferred Sectors</div>
          ...
          {(level === "full" || level === "self") && subcategories.length > 0 && (
            <div className="mb-4">
              <div className="text-sm text-[var(--text-muted)] mb-2">Subcategories</div>
              <div className="flex flex-wrap gap-2">
          ...
          {tags.length > 0 && (
            <div className="mb-4">
              <div className="text-sm text-[var(--text-muted)] mb-2">Custom Tags</div>
              <div className="flex flex-wrap gap-2">
                {tags.map((tag) => (
                  <span
                    key={tag}
          ...
          {(level === "full" || level === "self") && (
            <div className="grid grid-cols-2 gap-4 mt-4 pt-4 border-t border-[var(--border)]">
              <div>
                <div className="text-sm text-[var(--text-muted)]">Involvement</div>
                <div className="font-medium">{formatInvolvement(investorProfile.involvement)}</div>
              </div>
              <div>
                <div className="text-sm text-[var(--text-muted)]">Verified Deals Only</div>
