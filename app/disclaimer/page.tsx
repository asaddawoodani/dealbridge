    ...
    <div className="px-6 py-10">
      <div className="mx-auto max-w-3xl">
        ...
        <div className="prose-custom space-y-8 text-[var(--text-secondary)] text-sm leading-relaxed">
          ...
          <section>
            <h2 className="text-lg font-semibold text-[var(--text-primary)] mb-3">Not Investment Advice</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-[var(--text-primary)] mb-3">Risk Warning</h2>
            ...
            <ul className="list-disc pl-5 space-y-2 mt-2">
              <li><strong className="text-[var(--text-primary)]">Loss of capital:</strong> You may lose some or all of your invested capital.</li>
              <li><strong className="text-[var(--text-primary)]">Illiquidity:</strong> Private investments are typically illiquid. There may be no secondary market for your investment, and you may be unable to sell your position for an extended period.</li>
              <li><strong className="text-[var(--text-primary)]">Lack of information:</strong> Private companies are not subject to the same reporting requirements as publicly traded companies. Information may be limited, incomplete, or unaudited.</li>
              <li><strong className="text-[var(--text-primary)]">Dilution:</strong> Future funding rounds may dilute your ownership percentage.</li>
              <li><strong className="text-[var(--text-primary)]">Concentration risk:</strong> Individual private investments represent concentrated exposure to a single business or asset.</li>
            </ul>
          </section>

          <section>
            <h2 className="text-lg font-semibold text-[var(--text-primary)] mb-3">No Guarantees</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-[var(--text-primary)] mb-3">Regulatory Notice</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-[var(--text-primary)] mb-3">Your Responsibility</h2>
            <p>
